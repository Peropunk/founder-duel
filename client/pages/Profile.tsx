...
export default function ProfilePage() {
  ...
  useEffect(() => {
    /* ensure hook loads profile */
  }, []);

  const avatarSrc = useMemo(
    () => profile?.avatar_url ?? profile?.avatar_data ?? undefined,
    [profile],
  );
  ...
  async function handleAvatarChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    setProfile({
      ...profile,
      avatar_url: isData ? null : urlOrData,
      avatar_data: isData ? urlOrData : null,
    });
  }
  ...
  async function handleCoverChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    setProfile({
      ...profile,
      cover_url: isData ? null : urlOrData,
      cover_data: isData ? urlOrData : null,
    });
  }
      ...
      <div className="container max-w-3xl">
        <Card className="border-border/60 bg-card/80 backdrop-blur">
          <CardHeader>
            ...
            <CardDescription>
              Add your photo, founder and startup details. Saved to Supabase.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {!user && (
              <div className="mb-6 rounded-md border border-dashed p-4 text-sm text-muted-foreground">
                ...
                to save your profile in the cloud.
              </div>
            )}
                ...
                <div className="grid gap-2">
                  ...
                  <div className="relative h-40 w-full overflow-hidden rounded-lg border bg-muted">
                    {profile.cover_url || profile.cover_data ? (
                      <img
                        src={
                          profile.cover_url ?? profile.cover_data ?? undefined
                        }
                        alt="cover"
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setProfile({ ...profile, startup_name: e.target.value })
                      }
                    />
                  </div>
                </div>
